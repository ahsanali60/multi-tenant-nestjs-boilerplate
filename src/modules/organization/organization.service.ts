...
export class OrganizationService {
  ...
  async update(editOrganizationDto: EditOrganizationDto): Promise<object> {
    ...
    const result = await this.organizationRepository.update(
      { id: editOrganizationDto.organizationId },
      {
        ...
        tagLine: editOrganizationDto.tagLine,
      }
    );
  ...
  async updateSettings(settingsDto: any) {
    ...
    organization.headerColor = settingsDto.headerColor;
    organization.headerFontColor = settingsDto.headerFontColor;
    organization.buttonColor = settingsDto.buttonColor;
    organization.buttonFontColor = settingsDto.buttonFontColor;
    organization.primaryFontColor = settingsDto.primaryFontColor;
    ...
    organization.homepageUrl = settingsDto.homepageUrl;
    organization.tagLine = settingsDto.tagLine;
    organization.pdfUrl = settingsDto.pdfUrl;
    organization.customDomain = settingsDto.customDomain;
