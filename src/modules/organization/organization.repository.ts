...
export class OrganizationRepository extends Repository<Organization> {
  async createNew(organizationDto: OrganizationDto): Promise<Organization> {
    ...
    newOrg.pictureUrl = organizationDto.pictureUrl;
    newOrg.tagLine = organizationDto.tagLine;
    newOrg.headerColor = "#FFFFFF";
    newOrg.headerFontColor = "#000000";
    newOrg.buttonColor = "#2CABE1";
    newOrg.buttonFontColor = "#FFFFFF";
    newOrg.primaryFontColor = "#2CABE1";
